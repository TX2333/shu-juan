...
| Endpoint | `POST https://app-cyyl8odtf08x-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-cyyl8odtf08x-api-qYGW2z745vzY-gateway.appmiaoda.com` |
...
async function queryCaipiaoHistory(
  ...
  const url =
    `https://app-cyyl8odtf08x-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history?${params.toString()}`;
