...
- **Endpoint**：`POST https://app-cyyl8odtf08x-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-cyyl8odtf08x-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
